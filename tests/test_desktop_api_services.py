...
def test_pre_send_revalidation_targets_order_and_blocks_unconfirmed_wms_snapshot(
    tmp_path,
    monkeypatch,
) -> None:
    service = _service(tmp_path, RecordingClient([]))
    settings = DesktopSettings(queue_path="data/pre-send-notification.sqlite3")
    observed: dict[str, Any] = {}
