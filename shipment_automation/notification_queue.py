...
_STATUS_PRIORITY = {
    ...
    "AWAITING_REVIEW": 3,
    "RETRYABLE": 4,
    # Receipt follow-up comes directly after notifications ready to send.
    "ACCEPTED": 5,
    "DELIVERY_UNCONFIRMED": 6,
    STATUS_FAILED_STATUS_CHECK: 7,
    "MANUAL_EMAIL_REQUIRED": 8,
    STATUS_BLOCKED_NAME_CONFLICT: 9,
    "WAITING_CONTACT": 10,
    STATUS_BLOCKED_PRODUCT: 11,
    STATUS_BLOCKED_LOGISTICS_REVIEW: 11,
    "BLOCKED": 11,
    STATUS_FAILED_UNSENT: 12,
    STATUS_DELIVERED_PARTIAL: 13,
    "DELIVERED": 14,
    "MANUALLY_COMPLETED": 15,
    "SUPPRESSED": 16,
    STATUS_SUPPRESSED_DISABLED: 16,
    "REJECTED": 17,
    "CANCELLED": 18,
    "DRAFT": 19,
    "APPROVED": 19,
